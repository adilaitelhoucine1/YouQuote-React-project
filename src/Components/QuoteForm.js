...
>>>>>>> 5225cd61932cbdd8501a6ee6e4d208575a8c44a9
    </div>
  );
};
        ...
        <div className="mt-6">
          ...
          {activeTab === 'add' && (
            <QuoteForm 
              ...
              onNewCategory={() => setShowCategoryModal(true)} // Pass the new prop
            />
          )}
        </div>
      </main>
      ...
      <CategoryModal 
        ...
        onSubmit={async (name) => {
          ...
          if (newCategory) {
            ...
            // Set the newly created category as the selected one in the form
            setFormData(prev => ({
              ...prev,
